...
## Plan
After giving a general introduction to cloud computing in Week 1, we will provide a hands-on introduction to cloud computing by building projects in Azure each week. For the detailed discussion, please [see the docs](https://ctdcloud.readthedocs.io/en/latest/)!
